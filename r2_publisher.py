    ...
    def to_dict(self) -> dict:
        ...
        if self.challenge_passed is not None:
            d["challenge"] = {
                ...
                "token_pos": self.challenge_token_pos,
                "cosine_sim": round(self.cosine_sim, 6) if self.cosine_sim is not None else None,
                "latency_ms": round(self.challenge_latency_ms, 2) if self.challenge_latency_ms is not None else None,
